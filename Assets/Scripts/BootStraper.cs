...
public class BootStraper : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        _stateMachine = new StateMachine(SceneContext.ObjectSpawner, _spawnSettings, player, SceneContext.GridManager, _globalOptions, SceneContext.InGameUIController);
